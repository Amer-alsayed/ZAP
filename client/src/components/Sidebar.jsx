...
const Sidebar = React.memo(function Sidebar({
  ...
  useElasticBounce(contactsContainerRef, contactsBounceWrapperRef);
  ...
  return (
    <div className={`sidebar ${isMinimized ? 'sidebar-minimized' : ''}`}>
      ...
      <div className="contacts-list-container" ref={contactsContainerRef}>
        <div className="contacts-bounce-wrapper" ref={contactsBounceWrapperRef}>
